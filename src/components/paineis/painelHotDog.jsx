...
export default function PainelHotDog() {
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="border p-4 rounded-md bg-gray-50 space-y-3">
        <h2 className="text-xl font-bold mb-2">🌭 Hot Dog</h2>
        <input
          placeholder="Nome"
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-bold mb-2">Hot Dogs Cadastrados</h2>
        ...
        {docData.produtos.length === 0 && <p className="text-sm text-gray-500">Nenhum item cadastrado.</p>}
      </section>
