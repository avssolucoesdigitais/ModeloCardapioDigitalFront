      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex justify-end">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[450px] h-full bg-gray-50 shadow-2xl flex flex-col"
          >
            {/* Header Fixo */}
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {cart.items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center space-y-4">
                  ...
                  <p className="text-gray-500 font-medium">Seu carrinho está vazio.<br/>Que tal adicionar algo gostoso?</p>
                  <button 
                    onClick={onClose}
                ...
                cart.items.map((l, idx) => (
                  ...
                  >
                    {l.image && (
                      <img src={l.image} alt={l.name} className="w-20 h-20 object-cover rounded-2xl shadow-sm" />
                    )}
